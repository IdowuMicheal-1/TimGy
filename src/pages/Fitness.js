...
const Fitness = () => {
  return (
    <div className='container'>
        ...
        <div className='flex flex-col items-center justify-center md:flex-row md:items-center md:justify-center md:mx-auto space-y-6 md:space-y-0 w-full'>
            <div className='shadow-sm shadow-gray-800 rounded-2xl m-6 max-w-md flex items-left justify-center flex-col px-4 py-8'>
            ...
            <div className='shadow-sm shadow-pink rounded-2xl m-6 max-w-md flex items-left justify-center flex-col px-4 py-8'>
            ...
            <p className='text-gray-600 font-normal'>We offer a variety of membership plans to suit your lifestyle and budget. Whether you prefer month-to-month options or long-term commitments, we have a plan that's right for you. Plus, enjoy the flexibility to access our facilities at any time with our 24/7 availability.</p>
            </div>
